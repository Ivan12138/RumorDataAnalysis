...
|              |   类别   | (1)原始数据 | (2.1)对(1)的文本去重 | (2.2)对(2.1)进行样本均衡 | (2.3))删去(2.2)的topic图片 | (3.1)对(1)的图片去重 | (3.2)对(3.1)进行样本均衡 | (3.3)删去(3.2)的topic图片，并再去重 | (4.1)对(3.3)再去重 |
| :----------: | :------: | :---------: | :------------------: | :----------------------: | :------------------------: | :------------------: | :----------------------: | :---------------------------------: | :----------------: |
| **真实微博** | **文本** |   154114    |        38180         |           7909           |          **7909**          |          -           |            -             |                  -                  |         -          |
|              | **图片** |   183831    |        82058         |          16660           |         **16083**          | 183831<br />(未处理) |          22304           |                17677                |       12250        |
| **谣言微博** | **文本** |    34611    |         7880         |           7880           |          **7880**          |          -           |            -             |                  -                  |         -          |
|              | **图片** |    26586    |        11937         |          11937           |         **10310**          |        21963         |          21963           |                17494                |       12250        |
|   **备注**   |          |             |  **采用TF-IDF去重**  |                          |                            |   **采用SIFT去重**   |                          |          **采用pHash去重**          | **采用pHash去重**  |
